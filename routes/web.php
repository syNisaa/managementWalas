...
Route::get('/keuangan/cetak_pdf', 'DashController@keuangan_pdf');
...
Route::get('/siswa/cetak_pdf', 'DashController@siswa_pdf');
...
Route::get('/delete_jadwal/{id_jadwal}', 'RapatController@del_jadwal');