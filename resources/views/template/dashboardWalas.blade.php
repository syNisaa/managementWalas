...
<head>
    ...
    <link href="{{ asset ('frontpage//css/owl.theme.css')}}" rel="stylesheet" >
    <link href="{{ asset ('frontpage//css/owl.transitions.css')}}" rel="stylesheet" >
    <!-- meanmenu CSS
		============================================ -->
...
<body>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="logo-area">
                        ...
                        {{-- <a href="#"><img src="{{ asset ('frontpage/dashboard/img/logo/logo.png')}}" alt="" /></a> --}}
                    </div>
                </div>
                                ...
                                <div role="menu" class="dropdown-menu message-dd animated zoomIn">
                                    ...
                                    <div class="hd-message-info">
                                        <a href="#">
                                            <div class="hd-message-sn">
                                                <div class="hd-message-img">
                                                    <img src="{{ asset ('dashboard/img/post/1.jpg')}}" alt="" />
                                                </div>
                                                <div class="hd-mg-ctn">
                                                    <h3>David Belle</h3>
                                        ...
                                        <a href="#">
                                            <div class="hd-message-sn">
                                                <div class="hd-message-img">
                                                    <img src="{{ asset ('dashboard/img/post/4.jpg')}}" alt="" />
                                                </div>
                                                <div class="hd-mg-ctn">
                        ...
                        <nav id="dropdown">
                            <ul class="mobile-menu-nav">
                                    ...
                                    <li><a data-toggle="collapse" data-target="#Charts" href="#">Home</a>
                                        ...
                                        <li><a href="index-2.html">ADM Walas</a></li>
                                        <li><a href="index-3.html">Jadwal Mwngajar</a></li>
                                        <li><a href="index-4.html">Kapendik</a></li>
                                        <li><a href="analytics.html">Buku Hitam</a></li>
                    ...
                    <div class="tab-content custom-menu-content">
                        <div id="Home" class="tab-pane in active notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown">
                                ...
                                <li><a href="index-2.html">ADM Walas</a>
                                </li>
                                <li><a href="index-3.html">Jadwal Mengajar</a>
                                </li>
                                <li><a href="index-4.html">Kapendik</a>
                                </li>
                                <li><a href="analytics.html">Buku Hitam</a>
                                </li>
        ...
        <div class="container">
            <div class="row">
                ...
                {{-- <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30">
                        <div class="website-traffic-ctn">
                            <h2><span class="counter">MM</span></h2>
                            <p>Kelas</p>
                        </div> --}}
                ...
                {{-- <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30 dk-res-mg-t-30">
                        <div class="website-traffic-ctn">
                            <h2><span class="counter">TKJ</span></h2>
                            <p>Kelas</p>
                        </div> --}}
                ...
                {{-- <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30 dk-res-mg-t-30">
                        <div class="website-traffic-ctn">
                            <h2><span class="counter">TEI</span></h2>
                            <p>Kelas</p>
                        </div> --}}
                ...
                {{-- <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30 dk-res-mg-t-30" style="margin-top: 12px;">
                        <div class="website-traffic-ctn">
                            <h2><span class="counter">BC</span></h2>
                            <p>Kelas</p>
                        </div> --}}
                        {{-- <div class="sparkline-bar-stats4">2,4,8,4,5,7,4,7,3,5,7,5</div> --}}
                    {{-- </div>
    ...
    <!-- Start Footer area-->
    <div class="footer-copyright-area" style="margin-top: 180px;">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
